       ...
       try {
        ...
        throw (
         (P(n) && 409 === n.customData.serverCode
          ? await z(e.appConfig)
          : await G(e.appConfig, { fid: t.fid, registrationStatus: 0 }),
         n)
        );
       }
      })(e, n);
        ...
        if (2 === i) {
         ...
         t = {
          ...
          subscriptionOptions: {
           ...
           swScope: e.swScope,
           vapidKey:
            "string" == typeof e.vapidKey ? e.vapidKey : de(e.vapidKey),
          },
         };
        } else if (3 === i) {
         const e = c;
  ...
  if (
   ...
   return Date.now() >= i.createTime + 6048e5
    ? (async function (e, t) {
       try {
        const n = await (async function (e, t) {
          const n = await ke(e),
           ...
           a = { method: "PATCH", headers: n, body: JSON.stringify(i) };
          let r;
          try {
      ...
      })(e, { token: i.token, createTime: Date.now(), subscriptionOptions: n })
    : i.token;
  try {
...
function Ce(e) {
 ...
 return (
  ...
  (function (e, t) {
   ...
   if (
    !t.fcmOptions &&
    !(null === (n = t.notification) || void 0 === n ? void 0 : n.click_action)
   )
    return;
   e.fcmOptions = {};
   const s =
