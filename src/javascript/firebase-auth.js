  ...
  (this.auth = e),
   ...
   (this.promise = new Promise((e, t) => {
    this.timer = setTimeout(
     () => t(z(this.auth, "network-request-failed")),
     oe.get()
    );
   }));
 }
...
class ye {
 ...
 _stop() {
  this.isRunning &&
   ((this.isRunning = !1), null !== this.timerId && clearTimeout(this.timerId));
 }
 getInterval(e) {
  var t;
  if (e) {
...
class We {
    ...
    if (
     ...
     await this.initializeCurrentUser(t),
      (this.lastNotifiedUid =
       (null === (i = this.currentUser) || void 0 === i ? void 0 : i.uid) ||
       null),
 ...
 async updateCurrentUser(e) {
  ...
  return (
   t &&
    B(t.auth.config.apiKey === this.config.apiKey, this, "invalid-user-token"),
 ...
 get assertedPersistence() {
  return (
   B(this.persistenceManager, this, "internal-error"), this.persistenceManager
  );
 }
 _logFramework(e) {
  e &&
...
async function xt(e, t) {
 ...
 return (
  i.mfaInfo && (s = Dt._fromServerResponse(Ge(n), i.mfaInfo)),
  {
   data: {
    email:
     ("VERIFY_AND_CHANGE_EMAIL" === i.requestType ? i.newEmail : i.email) ||
     null,
    previousEmail:
     ("VERIFY_AND_CHANGE_EMAIL" === i.requestType ? i.email : i.newEmail) ||
     null,
    multiFactorInfo: s,
   },
   operation: r,
  ...
  : (function (e) {
     ...
     if (!i && (null == e ? void 0 : e.idToken)) {
      const i =
       null ===
        (n =
         null === (t = _e(e.idToken)) || void 0 === t ? void 0 : t.firebase) ||
       void 0 === n
        ? void 0
        : n.sign_in_provider;
 ...
 async unenroll(e) {
  ...
  try {
   const e = await Ie(
    ...
    ce(i, "POST", "/v2/accounts/mfaEnrollment:withdraw", ae(i, r)))
   );
...
class jn {
 ...
 render(e, t) {
  ...
  return (
   this._widgets.set(n, new zn(e, this.auth.name, t || {})), this.counter++, n
  );
 }
 reset(e) {
  var t;
   ...
   this.shouldResolveImmediately(t)
    ...
    : new Promise((n, i) => {
       const r = Nn().setTimeout(() => {
        i(z(e, "network-request-failed"));
       }, Wn.get());
       Nn()[qn] = () => {
        Nn().clearTimeout(r), delete Nn()[qn];
        const s = Nn().grecaptcha;
        if (!s) return void i(z(e, "internal-error"));
        const o = s.render;
        (s.render = (e, t) => {
         const n = o(e, t);
       ...
       xn(
        ...
        clearTimeout(r), i(z(e, "internal-error"));
       });
      })
  );
 }
...
class $n {
 ...
 makeTokenCallback(e) {
  return (t) => {
   if ((this.tokenChangeListeners.forEach((e) => e(t)), "function" == typeof e))
    e(t);
...
class hi extends ai {
 ...
 async onExecution() {
  ...
  (this.authWindow = await this.resolver._openPopup(
   ...
   this.resolver._isIframeWebStorageSupported(this.auth, (e) => {
    e || this.reject(z(this.auth, "web-storage-unsupported"));
   }),
 ...
 cancel() {
  this.reject(z(this.auth, "cancelled-popup-request"));
 }
 cleanUp() {
 ...
 pollUserCancellation() {
  const e = () => {
   ...
   (
    null ===
     (n = null === (t = this.authWindow) || void 0 === t ? void 0 : t.window) ||
    void 0 === n
     ? void 0
     : n.closed
   )
    ? (this.pollId = window.setTimeout(() => {
       (this.pollId = null), this.reject(z(this.auth, "popup-closed-by-user"));
      }, 2e3))
...
function Ii(e, t, n) {
 return (async function (e, t, n) {
  const i = Ge(e);
  W(e, t, ct), await i._initializationPromise;
  const r = ni(i, n);
...
function yi(e, t, n) {
 return (async function (e, t, n) {
  const i = T(e);
  W(i.auth, t, ct), await i.auth._initializationPromise;
  const r = ni(i.auth, n);
  await mi(r, i.auth);
  const s = await ki(i);
  ...
  (Li =
   ...
   (function (e) {
    return new Promise((t, n) => {
     ...
     function o() {
      Di(),
       gapi.load("gapi.iframes", {
        ...
        ontimeout: () => {
         Di(), n(z(e, "network-request-failed"));
        },
        timeout: Pi.get(),
       });
     }
     if (
      null ===
       (r = null === (i = Nn().gapi) || void 0 === i ? void 0 : i.iframes) ||
      void 0 === r
       ? void 0
       : r.Iframe
     )
      ...
      if (!(null === (s = Nn().gapi) || void 0 === s ? void 0 : s.load)) {
       ...
       return (
        (Nn()[t] = () => {
         gapi.load ? o() : n(z(e, "network-request-failed"));
        }),
...
function zi(e, t, n, i = 500, r = 600) {
 const s = Math.max((window.screen.availHeight - r) / 2, 0).toString(),
  o = Math.max((window.screen.availWidth - i) / 2, 0).toString();
 let a = "";
 const c = Object.assign(Object.assign({}, Hi), {
   width: i.toString(),
   height: r.toString(),
   top: s,
   left: o,
  ...
  u = d().toLowerCase();
 n && (a = Le(u) ? "_blank" : n),
  Pe(u) && ((t = t || "http://localhost"), (c.scrollbars = "yes"));
 ...
 if (
  (function (e = d()) {
   ...
   return (
    xe(e) &&
    !!(null === (t = window.navigator) || void 0 === t ? void 0 : t.standalone)
   );
  })(u) &&
  "_self" !== a
 )
     ...
     t.open(
      ...
      (t) =>
       new Promise(async (n, i) => {
        ...
        const r = z(e, "network-request-failed"),
         s = Nn().setTimeout(() => {
          i(r);
         }, Ui.get());
        function o() {
...
const Ji = u("authIdTokenMaxAge") || 300;
let Yi = null;
function Xi(t = i()) {
 const n = e(t, "auth");
 if (n.isInitialized()) return n.getImmediate();
 const r = X(t, { popupRedirectResolver: Wi, persistence: [Vn, En, bn] }),
  s = u("authTokenSyncURL");
 if (s) {
  const e =
   ((o = s),
   async (e) => {
 ...
 const a =
  ((d = "auth"),
  null ===
   (h = null === (l = c()) || void 0 === l ? void 0 : l.emulatorHosts) ||
  void 0 === h
   ? void 0
   : h[d]);
 var d, l, h;
...
export {
 ...
 Wi as browserPopupRedirectResolver,
 ...
 zt as signInWithEmailAndPassword,
